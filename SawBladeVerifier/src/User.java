...
public class User {
	...
	/*
	 * This method determine if the input is positive or not and if input is not positive
	 * it will prompt Enter positive number only and user has to input value again.
	 */
	public static double inputPositiveDouble(String prompt) {
		...
		if (value >= 0) {
			...
			value = inputPositiveDouble(prompt);
		}	
		return value;
	}
}